...
namespace LM.Core.Data
{
    public interface IDbSession
    {
        ...
        /// <returns></returns>
        IEnumerable<T> SqlQuery<T>(string sql, bool trackEnabled = true, params object[] parameters) where T : class;
        int SaveChanges();
        int BulkSaveChanges();
        void SetAutoDetectChangesEnabled(bool isClose);
        void ValidateOnSaveEnabled(bool isClose);
        void LazyLoadingEnabled(bool isClose);
        void ProxyCreationEnabled(bool isClose);
    }
}
