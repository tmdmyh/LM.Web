...
namespace LM.Core.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Container manager
    /// </summary>
    public class ContainerManager
    {
        ...
        public virtual T Resolve<T>( params Parameter[] param)
        {
            return scope.ResolveKeyed<T>(param);
        }
        /// <summary>
        /// Resolve
        /// </summary>
        ...
        public T ResolveNamed<T>(string name,  params Parameter[] param)
        {
           
            return scope.ResolveNamed<T>(name, param);
        }
        public T ResolveKeyed<T>(string name, params Parameter[] param)
        {
           
            return scope.ResolveKeyed<T>(name, param);
        }
